 ...
 * This file demonstrates how to integrate Maplanddecentral with a web frontend
 */

// For React/Vue/Angular applications
export class MaplanddecentralClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MaplanddecentralClient(provider, contractAddress);
