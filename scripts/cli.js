...
const contractABI = require("../artifacts/contracts/Maplanddecentral.sol/Maplanddecentral.json").abi;

program
    .name("maplanddecentral-cli")
    .description("CLI tool for Maplanddecentral smart contract")
    .version("1.0.0");
